...
# Django settings for cCard2 project.
...
DATABASES = {
    ...
    'mobile': {
        ...
        'NAME': 'ccard.db',  # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': '',
        'PASSWORD': '',
...
SECRET_KEY = 'l&idxfin_4z4t+=n_p4*2id&6b!k!7ml)wd9h@v=*lg5r&(t34'
...
ROOT_URLCONF = 'cCard2.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'cCard2.wsgi.application'
